...
| [SAR](https://github.com/stac-extensions/sar)                | sar              | sar               | Item, Collection          | *Proposal* | Reviewed      | Covers synthetic-aperture radar data that represents a snapshot of the earth for a single date and time. |
| [Satellite](https://github.com/stac-extensions/sat)          | sat              | sat               | Item, Collection          | *Proposal* | Reviewed      | Satellite related metadata for data collected from satellites. |
