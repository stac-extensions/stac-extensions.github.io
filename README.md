...
| [Landsat](https://landsat.usgs.gov/stac/landsat-extension/v1.1.1/schema.json)* | landsat | *Unknown* | *Unknown* | *Unknown* | *JSON Schema only!* |
| [Landsat ARD Tile](https://landsat.usgs.gov/stac/landsat-ard-extension/v1.0.0/schema.json)* | landsat | *Unknown* | *Unknown* | *Unknown* | *JSON Schema only!* |
...
| [Raster](https://github.com/stac-extensions/raster) | raster | Collection, Item | Proposal | 1.1.0 | Describes raster assets at band level (one or multiple) with specific information such as data type, unit, number of bits used, nodata. |
| [SAR](https://github.com/stac-extensions/sar) | sar | Collection, Item | Proposal | 1.0.0 | Covers synthetic-aperture radar data that represents a snapshot of the earth for a single date and time. |
...
| [Versioning Indicators](https://github.com/stac-extensions/version) | - | Collection, Item | Proposal | 1.1.0 | Provides fields and link relation types to provide a version and indicate deprecation. |
...
**Last updated:** Dec 07 2022, 17:39 
