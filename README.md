...
| ----- | ----------------- | ----- | ----------------------------------------------------------------------------------------------- | ------- | ------------ | ----------- |
| [3D City Models](https://github.com/cityjson/stac-city3d)* | city3d | Collection, Item | Proposal | 0.2.0 | 2026-07-07 | STAC extension for 3D city models |
...
| [alternate-assets](https://github.com/stac-extensions/alternate-assets) | *Unknown* | *Unknown* | *Unknown* | 1.2.0 | 2024-07-09 | Describes alternate locations and mirrors of assets |
...
| [anonymized-location](https://github.com/stac-extensions/anonymized-location) | *Unknown* | *Unknown* | *Unknown* | 1.0.0 | 2021-04-30 | Provides a way to anonymize location data |
...
| [datacube](https://github.com/stac-extensions/datacube) | *Unknown* | *Unknown* | *Unknown* | 2.3.0 | 2025-06-18 | Datacube related metadata to describe their dimensions and variables. |
...
| [eo](https://github.com/stac-extensions/eo) | *Unknown* | *Unknown* | *Unknown* | 2.0.0 | 2024-09-09 | Covers electro-optical data that represents a snapshot of the Earth. It could consist of cloud cover and multiple spectral bands, for example visible bands, infrared bands, red edge bands and panchromatic bands. |
...
| [Film](https://github.com/linz/stac/tree/master/extensions/film)* | *Unknown* | *Unknown* | *Unknown* | *Unknown* | *Unknown* | Film related metadata, such as roll, negative sequence and other physical attributes. Especially useful for digitised historic aerial imagery surveys. |
...
| [noaa-mrms-qpe](https://github.com/stac-extensions/noaa-mrms-qpe) | *Unknown* | *Unknown* | *Unknown* | 1.0.0 | 2022-10-24 | STAC Extension for NOAA MRMS QPE (Multi-Radar Multi-Sensor Quantitative Precipitation Estimation) products |
...
| [Quality](https://github.com/linz/stac/tree/master/extensions/quality)* | *Unknown* | *Unknown* | *Unknown* | *Unknown* | *Unknown* | Geospatial quality and accuracy of collections, such as horizontal and vertical accuracy. |
...
| [timestamps](https://github.com/stac-extensions/timestamps) | *Unknown* | *Unknown* | *Unknown* | 1.1.0 | 2023-01-05 | Allows to specify numerous additional timestamps for assets and metadata. |
...
| [virtual-assets](https://github.com/stac-extensions/virtual-assets) | *Unknown* | *Unknown* | *Unknown* | 1.0.0 | 2023-11-09 | Allows the description of virtual assets composed from 2 or more assets with cross references and repositioning. |
...
| [xarray-assets](https://github.com/stac-extensions/xarray-assets) | *Unknown* | *Unknown* | Deprecated | 1.0.0 | 2021-06-30 | This extension helps users open STAC Assets with xarray. It gives a place for catalog maintainers to specify various required or recommended options. |
...
* **Last updated:** Jul 09 2026, 03:25 UTC
* **Count:** 89
