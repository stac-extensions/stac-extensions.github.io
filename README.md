...
| [ML AOI](https://github.com/stac-extensions/mgrs)            | ml-aoi            | Item, Collection          | **WIP**    | **No**     | An Item and Collection extension to provide labeled training data for machine learning models. |
