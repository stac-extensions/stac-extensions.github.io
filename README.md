...
| [File Info](https://github.com/stac-extensions/file)         | file             | file              | Item, Collection          | *Proposal* | Updated       | Provides a way to specify file details such as size, data type and checksum for assets in Items and Collections. |
...
| [Label](https://github.com/stac-extensions/label)            | label            | label             | Item                      | *Proposal* | Updated       | Items that relate labeled AOIs with source imagery           |
...
| [SAR](https://github.com/stac-extensions/sar)                | sar              | sar               | Item                      | *Proposal* | Updated       | Covers synthetic-aperture radar data that represents a snapshot of the earth for a single date and time. |
| [Satellite](https://github.com/stac-extensions/sat)          | sat              | sat               | Item                      | *Proposal* | Updated       | Satellite related metadata for data collected from satellites. |
